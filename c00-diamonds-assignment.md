...
**Observations**:
  ...
  - Price goes up as carats go up.
  - There are many points gathered close to each step in carat size.
...
**Observations**:
  ...
  - Fair cuts make up the bulk of the lowest priced diamonds.
  - There doesn’t appear to be a significant difference in price between
    premium and ideal cut diamonds.
  - Larger carat sizes within each whole number bucket appear to be more
    likely to have a lower quality cut.
